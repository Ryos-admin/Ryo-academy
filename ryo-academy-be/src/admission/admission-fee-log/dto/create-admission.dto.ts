...
export class CreateFeePaymentDetailsDto {
    ...
    @ApiProperty({
        description: 'Name of the fee component associated with the fee payment detail',
        example: 'Tuition Fee',
    })
    @IsString()
    @IsNotEmpty()
...
export class CreateAdmissionDto {
    ...
    @ApiProperty({
        description: 'Admission sequence number, e.g., 1 for the first admission of the year',
        example: 1,
    })
    @IsNumber()
    @IsNotEmpty()
